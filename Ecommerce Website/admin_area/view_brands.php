    ...
    <tbody>
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <tr class="text-center">
                ...
                <td class='bg-secondary'><a href='index.php?edit_brands=<?php echo $brand_id ?>'><i class='fa-solid 
                ...
                <td class='bg-secondary text-light'><a href='index.php?delete_brands=<?php echo $brand_id ?>' type="button"
                        class="text-light" data-toggle="modal" data-target="#exampleModal"><i class='fa-solid 
