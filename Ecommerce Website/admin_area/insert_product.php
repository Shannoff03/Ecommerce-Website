...
if (isset($_POST['insert_product'])) {
   ...
   if (
      $product_title == '' or $descrption == '' or $product_keywords == '' or $product_category == ''
      ...
      product_price,date,status) values ('$product_title','$descrption','$product_keywords',
...
<body class="bg-light">
   <div class="container mt-3">
      ...
      <form action="" method="post" enctype="multipart/form-data">
         ...
         <!--descrption  -->
         <div class="form-outline mb-4 w-50 m-auto">
            <label for="descrption" class="form-label">Product Description</label>
